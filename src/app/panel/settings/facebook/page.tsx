        ...
        <div className="flex min-h-screen bg-[#0f1115] overflow-hidden h-screen">
            ...
            <div className="flex-1 overflow-y-auto h-full p-8 relative custom-scrollbar">
                <IntegrationLanding
                    ...
                    icon={Facebook}
                    description="Manage your Facebook Messenger conversations and comments directly from your Tidio inbox to respond to customer questions quickly. Fewer distractions from switching platforms, more productivity for you."
